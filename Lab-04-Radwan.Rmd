...
###Group growth rate by metro area
...
Based on the 3 selected variables (percent white residents, percent with college education), they could predict the change significantly in the median home values between 2000 and 2010. 

The Adjusted R2 for Model 4 with all three variables included was 0.31 and
significant at the p<0.01 level. Each of these variables had a negative correlation,
Therefore, there is a higher percentage of white residents and a higher percentage of college graduates
Higher education and poverty rate both indicate smaller changes in median home values.

Although this relationship was expected for the high priced tracts that has white higher educated residents as they are not under the threat of gentrification, the poverty rate has also a negative correlation. Also in Model 2 where college education is not included, poverty rate has a positive
