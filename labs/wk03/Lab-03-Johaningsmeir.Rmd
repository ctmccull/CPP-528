...
census_api_key( "f83e5ad5e886a08bbc323466aab092e5f74f1fa9")
...
### Part 1 answer:
### From 1990-2000 the median home value increased from $113,446 to $119,900, while
### the mean value decreased from $147,601 to $144,738 during the same period.
...
In my discussion post, I proposed criteria to identify census tracts eligible
for gentrification as having the following
* Low home values
* Low rents
...
```
Using all of the criteria I listed, only 439 tracts were eligible for gentrification
...
for gentrification increased 7278.
