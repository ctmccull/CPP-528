...
*Based on proposal by Sarah J. to be used by group, the following factor will predict the tract gentrification  (- Low home values, - Low rents,- High rate of vacant units,  - High proportion of racial/ethnic minority residents, - High rate of unemployment, - Low % with college degree or more education and - High poverty rate)*
