...
d1 <- data.frame( y=y1, treat.nmtc=treat.nmtc, post=0, p.white = d$p.white.00,
                  p.col.edu.00 = d$p.col.edu.00, pov.rate.00 = d$pov.rate.00 )
# store the year 2010 NMTC data
d2 <- data.frame( y=y2, treat.nmtc=treat.nmtc, post=1, p.white = d$p.white.00,
                  p.col.edu.00 = d$p.col.edu.00, pov.rate.00 = d$pov.rate.00   )
...
d4 <- data.frame( y=y1, treat.lihtc=treat.lihtc, post=0,  p.white = d$p.white.00,
                  p.col.edu.00 = d$p.col.edu.00, pov.rate.00 = d$pov.rate.00 ) 
# Store 2010 LIHTC
d5 <- data.frame( y=y2, treat.lihtc=treat.lihtc, post=1,  p.white = d$p.white.00,
                  p.col.edu.00 = d$p.col.edu.00, pov.rate.00 = d$pov.rate.00 )
