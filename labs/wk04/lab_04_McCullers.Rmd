...
Each of the three variables chosen (percent white residents, percent with college
...
these models had an Adjust R2 of 0.30 to 0.31. This is likely because of the strong
correlations between the variables. 

Model 4 with all three variables included produced an Adjusted R2 of 0.31, 
significant  at the p<0.01 level. The direction for each of these coefficients was negative,
thus a higher percentage of white residents, higher percentage with a college
education, or higher poverty rate all indicate a decrease in median home values.
...
am surprised to see that poverty rate is also a negative association. (Perhaps there 
is a multicollinearity issue with the other variables, especially college-education, 
since the direction of the association does not change until model 3.)
